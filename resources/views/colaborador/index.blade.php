...
@section('actions')
    <a data-toggle="modal" data-target="#modal-form" class="btn btn-float has-text">
        <i class="nav-icon fa fa-user"></i><span>Cadastrar<br>Colaborador</span>
    </a>
@endsection
    ...
    <div class="modal fade" id="modal-form">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('colaborador.create') }}" class="form form-ajax-master" enctype="multipart/form-data" method="post">
                    @csrf
